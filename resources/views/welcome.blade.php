...
<section class="mb-40">
  ...
  <!-- Background image -->
  <div
    class="relative overflow-hidden bg-cover bg-no-repeat bg-[50%] bg-[url('https://img.freepik.com/photos-gratuite/ouvrier-du-batiment_329181-2851.jpg?t=st=1708553038~exp=1708556638~hmac=55b59f717c2cd0198f7a856f108e6953351fb31b0d4b66acd0324ce229adc522&w=996')] h-[500px]">
  </div>
            ...
            <div class="grid grid-cols-1 gap-12 xl:grid-cols-3">
                <div class="steps__step text-center">
                    ...
                    <p class="mb-5 max-w-md mx-auto">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Commodi accusamus nostrum laudantium? Laboriosam, recusandae aspernatur.
                    </p>
...
<section class="about mt-[80px] xl:mt-[200px] relative z-20 overflow-hidden" >
        <div class="container mx-auto xl:px-0">
            <div class="flex flex-col xl:flex-row text-center xl:text-left justify-around items-center gap-5 xl:gap-[74px] ">
                <div class="about__text order-2 xl:order-none max-w-xl xl:max-w-[410px] flex flex-col items-center xl:items-start gap-8">
                    <h2 class="font-serif text-6xl font-extrabold h2">Lorem ipsum dolor sit amet.</h2>
                    <p>
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores odio doloribus dolor ratione reprehenderit suscipit!lorem5
                ...
                <div class="about__img order-1 xl:order-none max-w-[453px] mx-auto xl:max-w-none xl:mx-0">
                    <img src="https://img.freepik.com/photos-gratuite/professionnel-plomberie-fait-son-travail_23-2150721551.jpg?t=st=1708561923~exp=1708565523~hmac=2251a48f10b253dcb954efe6e3d4b6d8765f42a7813d70c1f59bf1038051e47e&w=996" class="rounded-bl-[50%] rounded-tr-[30%]" alt="">
                </div>
            </div>
        </div>
    </section>
...
<footer
  class="mt-10 flex flex-col items-center bg-neutral-900 text-center text-white">
            ...
            const observer = new IntersectionObserver(entries => {
                entries.forEach(entry => {
                    if (entry.isIntersecting) {
                        ...
                        observer.unobserve(entry.target); // Arrêter d'observer une fois l'animation terminée
                    }
                });
            }, { threshold: 0.5, once: true }); // Utiliser `once: true` pour déclencher l'animation une seule fois
